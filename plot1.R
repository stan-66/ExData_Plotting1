## construct plot 1: frequency of Global_active_power variable
...
# Construct Plot 1: distribution of global active power
png("plot1.png", width=480, height=480, units="px")
hist(PConsFeb$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
dev.off()